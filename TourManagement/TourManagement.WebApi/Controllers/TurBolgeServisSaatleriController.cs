...
namespace TourManagement.WebApi.Controllers
{
    ...
    [ApiController]
    public class TurBolgeServisSaatleriController : BaseApiController<ITurBolgeServisSaatleriRepository, TurBolgeServisSaatleriRepository, VmTurBolgeServisSaatleri, TurBolgeServisSaatleri>
    {
    }
}