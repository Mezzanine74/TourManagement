...
@Component({
  selector: 'app-arac-tip-list',
  templateUrl: './arac-tip-list.component.html',
  styleUrls: ['./arac-tip-list.component.scss']
})
export class AracTipListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiAracTip;
    this.editPageUrl = () => Constants.aracTipEdit;
