...
@Component({
  selector: 'app-arac-tip-edit',
  templateUrl: './arac-tip-edit.component.html',
  styleUrls: ['./arac-tip-edit.component.scss']
})
export class AracTipEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiAracTip;
    this.listPageUrl = ():string => Constants.aracTipList;
