...
@Component({
  selector: 'app-uyruk-edit',
  templateUrl: './uyruk-edit.component.html',
  styleUrls: ['./uyruk-edit.component.scss']
})
export class UyrukEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiUyruk;
    this.listPageUrl = ():string => Constants.uyrukList;
