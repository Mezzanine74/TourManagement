...
@Component({
  selector: 'app-uyruk-list',
  templateUrl: './uyruk-list.component.html',
  styleUrls: ['./uyruk-list.component.scss']
})
export class UyrukListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiUyruk;
    this.editPageUrl = () => Constants.uyrukEdit;
