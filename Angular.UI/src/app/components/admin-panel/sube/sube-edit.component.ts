...
@Component({
  selector: 'app-sube-edit',
  templateUrl: './sube-edit.component.html',
  styleUrls: ['./sube-edit.component.scss']
})
export class SubeEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiSube;
    this.listPageUrl = ():string => Constants.subeList;
