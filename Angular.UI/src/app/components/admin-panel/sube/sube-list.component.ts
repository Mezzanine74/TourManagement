...
@Component({
  selector: 'app-sube-list',
  templateUrl: './sube-list.component.html',
  styleUrls: ['./sube-list.component.scss']
})

export class SubeListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiSube;
    this.editPageUrl = () => Constants.subeEdit;
