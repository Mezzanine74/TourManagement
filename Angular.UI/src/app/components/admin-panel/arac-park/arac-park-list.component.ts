...
@Component({
  selector: 'app-arac-park-list',
  templateUrl: './arac-park-list.component.html',
  styleUrls: ['./arac-park-list.component.scss']
})
export class AracParkListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiAracPark;
    this.editPageUrl = () => Constants.aracParkEdit;    
    this.apiAracTipUrl = () => Constants.apiRoot + Constants.apiAracTip;
    ...
    this.aracTipDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiAracTipUrl())
            .toPromise();
      }
    });
