...
@Component({
  selector: 'app-tour-tip-list',
  templateUrl: './tour-tip-list.component.html',
  styleUrls: ['./tour-tip-list.component.scss']
})
export class TourTipListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiTourTip;
    this.editPageUrl = () => Constants.tourTipEdit;
