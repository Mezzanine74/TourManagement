...
@Component({
  selector: 'app-tour-tip-edit',
  templateUrl: './tour-tip-edit.component.html',
  styleUrls: ['./tour-tip-edit.component.scss']
})
export class TourTipEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiTourTip;
    this.listPageUrl = ():string => Constants.tourTipList;
