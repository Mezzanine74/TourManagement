...
@Component({
  selector: 'app-tur-bolge-servis-saatleri-list',
  templateUrl: './tur-bolge-servis-saatleri-list.component.html',
  styleUrls: ['./tur-bolge-servis-saatleri-list.component.scss']
})
export class TurBolgeServisSaatleriListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiTurBolgeServisSaatleri;
    this.editPageUrl = () => Constants.turBolgeServisSaatleriEdit;
    this.apiBolgeUrl = () => Constants.apiRoot + Constants.apiBolge;
    this.apiTourTipUrl = () => Constants.apiRoot + Constants.apiTourTip;
    ...
    this.tourTipDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiTourTipUrl())
            .toPromise();
      }
    });
