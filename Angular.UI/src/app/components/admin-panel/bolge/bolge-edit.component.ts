...
@Component({
  selector: 'app-bolge-edit',
  templateUrl: './bolge-edit.component.html',
  styleUrls: ['./bolge-edit.component.scss']
})
export class BolgeEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiBolge;
    this.listPageUrl = ():string => Constants.bolgeList;
