...
@Component({
  selector: 'app-bolge-list',
  templateUrl: './bolge-list.component.html',
  styleUrls: ['./bolge-list.component.scss']
})
export class BolgeListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiBolge;
    this.editPageUrl = () => Constants.bolgeEdit;
