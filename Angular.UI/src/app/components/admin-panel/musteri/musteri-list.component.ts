...
@Component({
  ...
  styleUrls: ['./musteri-list.component.scss']
})
export class MusteriListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiMusteri;
    this.editPageUrl = () => Constants.musteriEdit;
    this.apiUyrukUrl = () => Constants.apiRoot + Constants.apiUyruk;    
    this.apiOtelUrl = () => Constants.apiRoot + Constants.apiOtel;    
    ...
    this.uyrukDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiUyrukUrl())
            .toPromise();
      }
    });

    this.otelDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiOtelUrl())
            .toPromise();
      }
    });    
