...
@Component({
  selector: 'app-otel-edit',
  templateUrl: './otel-edit.component.html',
  styleUrls: ['./otel-edit.component.scss']
})
export class OtelEditComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private httpClient:HttpClient, private router: Router) { 
    ...
    this.apiUrl = ():string => Constants.apiRoot+ Constants.apiOtel;
    this.listPageUrl = ():string => Constants.otelList;
