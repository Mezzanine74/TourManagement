...
@Component({
  selector: 'app-bilet-list',
  templateUrl: './bilet-list.component.html',
  styleUrls: ['./bilet-list.component.scss']
})
export class BiletListComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private router: Router, private activatedRoute: ActivatedRoute) { 
    ...
    this.apiUrl = () => Constants.apiRoot + Constants.apiBilet;
    this.editPageUrl = () => Constants.biletEdit;
    this.apiSubeUrl = () => Constants.apiRoot + Constants.apiSube;    
    this.apiTourUrl = () => Constants.apiRoot + Constants.apiTour;    
    this.apiMusteriUrl = () => Constants.apiRoot + Constants.apiMusteri;    
    this.apiCurrencyUrl = () => Constants.apiRoot + Constants.apiCurrency;    
    ...
    this.subeDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiSubeUrl())
            .toPromise();
      }
    });
    ...
    this.musteriDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiMusteriUrl())
            .toPromise();
      }
    });    
    
    this.currencyDataSource = new CustomStore({  
      key: "id",        
      load: (loadOptions):any => {
        return this.httpClient.get(this.apiCurrencyUrl())
            .toPromise();
      }
    });    
